...
function curl_coinMarketCap($table_name, $currency, $batch_id, $provider_id)
{
    ...
    $params["CMC_PRO_API_KEY"] = "13311c25-a14e-4ff9-9e7c-881befca82f4";
    $params["aux"] = "cmc_rank";
        ...
        elseif(is_array($result) && !empty($result)){
            ...
            foreach ($result["data"] as $data) {
                ...
                $insertData = array(
                    ...
                    "market_cap_rank" => $data["cmc_rank"] ? $data["cmc_rank"] : '',
                    "created_at" => date('Y-m-d H:i:s'),
                    "value" => $data["quote"]["USD"]["price"] ? $data["quote"]["USD"]["price"] : "",
                    "price_change_percentage_24h" => $data["quote"]["USD"]["percent_change_24h"] ? $data["quote"]["USD"]["percent_change_24h"] : "",
                    "market_cap" => $data["quote"]["USD"]["market_cap"] ? $data["quote"]["USD"]["market_cap"] : '',
                );
