<?php 
	...
	class Activity {
		...
		function insertActivity($title, $translationCode, $activityData, $creatorID, $creatorType) {
            $db = $this->db;
            ...
            $fields    = array("title", "translation_code", "data", "creator_id", "creator_type", "created_at");
            $values    = array($title, $translationCode, $activityData, $creatorID, $creatorType, $createdAt);
